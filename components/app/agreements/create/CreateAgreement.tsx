                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Select value={form.training_opt_out} onValueChange={(v) => setForm((p) => ({ ...p, training_opt_out: v }))}>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={form.audit_rights} onValueChange={(v) => setForm((p) => ({ ...p, audit_rights: v }))}>
                                        <SelectTrigger className="w-full"><SelectValue placeholder="Select" /></SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="yes">Yes</SelectItem>
                                            <SelectItem value="no">No</SelectItem>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={form.transfer_mechanism} onValueChange={(v) => setForm((p) => ({ ...p, transfer_mechanism: v }))}>
                                        <SelectTrigger className="w-full"><SelectValue placeholder="Select" /></SelectTrigger>
                                        <SelectContent>
