...
const DatasetForm: React.FC<DatasetFormProps> = ({
    ...
    const handleArrayRemove = (field: "source_ids" | "data_subject_categories" | "content_types", valueToRemove: string | number) => {
        if (field === "source_ids") {
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2 w-full">
                        <Label htmlFor="contains_pii">Contains PII <span className="text-red-500">*</span></Label>
                        <Select
            ...
            <div className="space-y-4">
                ...
                {/* Consent fields - Only shown when lawful_basis is "Consent" */}
                {showConsentFields && (
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2 w-full">
                                <Label htmlFor="consent_required">Consent Required <span className="text-red-500">*</span></Label>
                                <Select
                                    key={`consent_required-${formData.consent_required ? 'true' : 'false'}`}
                                    value={formData.consent_required ? "Yes" : "No"}
                                    onValueChange={(value) => handleInputChange("consent_required", value === "Yes")}
                                >
                                    <SelectTrigger className={errors.consent_required ? "border-destructive w-full" : "w-full"}>
                                        <SelectValue placeholder="Select" />
                                    </SelectTrigger>
                                    <SelectContent>
                                        <SelectItem value="Yes">Yes</SelectItem>
                                ...
                                {errors.consent_required && (
                                    <p className="text-sm text-destructive">{errors.consent_required[0]}</p>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    min="0"
                                    max="100"
                                    value={formData.consent_coverage_pct !== undefined && formData.consent_coverage_pct !== null ? formData.consent_coverage_pct : ""}
                                    onChange={(e) => handleInputChange("consent_coverage_pct", e.target.value ? parseInt(e.target.value, 10) : undefined)}
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder="Link to consent artifacts (optional)"
                                />
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2 w-full">
                        <Label htmlFor="data_structure">Data Structure <span className="text-red-500">*</span></Label>
                        <Select
                    ...
                    <div className="space-y-2 w-full">
                        <Label htmlFor="storage_format">Storage Format <span className="text-red-500">*</span></Label>
                        <Select
                    ...
                    <div className="space-y-2 w-full">
                        <Label htmlFor="cross_border_transfer">Cross-Border Transfer <span className="text-red-500">*</span></Label>
                        <Select
