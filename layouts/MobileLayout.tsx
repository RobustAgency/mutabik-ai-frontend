...
const MobileLayout = ({ children, sidebarOpen, setSidebarOpen }: { children: React.ReactNode, sidebarOpen: boolean, setSidebarOpen: (open: boolean) => void }) => {
    return (
        <>
            <Drawer open={sidebarOpen} onOpenChange={setSidebarOpen} direction="left">
                <Header />
                <DrawerContent className="w-full max-w-[280px] p-0 md:hidden">
