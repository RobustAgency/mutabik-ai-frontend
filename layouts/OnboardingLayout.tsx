  ...
  return (
    <div className="flex w-full min-h-screen overflow-hidden">
      ...
      <div className="flex-1 w-full md:ml-[260px] flex flex-col min-h-screen">
        <header className="w-full fixed top-0 left-0  z-20 bg-white flex flex-row justify-end items-center h-[70px] md:h-[100px] px-4 py-4 gap-4">
        ...
        {/* Main content area */}
        <main className="flex-1 w-full bg-white pt-[150px] px-2 md:px-20 lg:px-36 pb-8 max-md:ml-5">
          {children}
        </main>
      </div>
    </div>
