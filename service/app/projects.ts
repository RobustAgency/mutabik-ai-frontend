...
export class ProjectService {
    async getProjects(filters?: ProjectFilters): Promise<ApiResponse<{ data: Project[] }>> {
    ...
    async addMember(projectId: number, data: AddMemberData): Promise<ApiResponse<null>> {
        return api.post(`/projects/${projectId}/add-member`, data);
    }

    async addFrameworks(projectId: number, data: AddFrameworksData): Promise<ApiResponse<null>> {
        return api.post(`/projects/${projectId}/add-frameworks`, data);
    }
}
